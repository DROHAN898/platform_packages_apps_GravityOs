...
package com.gravity.gos.advanced;
...
import com.gravity.gos.preference.CustomSeekBarPreference;
...
public class SystemCategory extends SettingsPreferenceFragment implements
    ...
    private static final String PREF_gravity_SETTINGS_SUMMARY = "gravity_settings_summary";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.gravity_system);
        ...
        mCustomSummary = (Preference) prefScreen.findPreference(PREF_gravity_SETTINGS_SUMMARY);
            ...
            alert.setPositiveButton(getString(android.R.string.ok),
                    new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            ...
                            Settings.System.putString(resolver, Settings.System.gravity_SETTINGS_SUMMARY, value);
                            updateCustomSummaryTextString();
                        }
                    });
    ...
    private void updateCustomSummaryTextString() {
        mCustomSummaryText = Settings.System.getString(
                getActivity().getContentResolver(), Settings.System.gravity_SETTINGS_SUMMARY);

        if (TextUtils.isEmpty(mCustomSummaryText)) {
            mCustomSummary.setSummary(R.string.gos_summary_title);
        } else {

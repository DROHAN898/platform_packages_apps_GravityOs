...
import com.android.internal.util.gravity.PowerMenuConstants;
import static com.android.internal.util.gravity.PowerMenuConstants.*;
...
public class PowerMenuFragment extends SettingsPreferenceFragment {
    ...
    public void onStart() {
       ...
       if (mFlashlightPref != null) {
            if (!gravityUtils.deviceSupportsFlashLight(getActivity())) {
